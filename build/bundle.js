var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0 = element("div");
    			span = element("span");
    			t0 = text(/*progressPercent*/ ctx[0]);
    			t1 = text("%");
    			attr(span, "class", "sr-only");
    			attr(div0, "class", "progress-bar svelte-5ashfu");
    			set_style(div0, "width", /*progressPercent*/ ctx[0] + "%");
    			attr(div1, "class", "progress-container svelte-5ashfu");
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*progressPercent*/ 1) set_data(t0, /*progressPercent*/ ctx[0]);
    ...
    class ProgressBar extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$3, safe_not_equal, { progressPercent: 0 });
    	}
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	progressbar = new ProgressBar({
    			props: {
    				progressPercent: /*progressPercent*/ ctx[2]
    			}
    		});
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-1gws35t");
    			attr(div0, "bp", "grid");
    			attr(button, "class", "start svelte-1gws35t");
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*progressPercent*/ 4) progressbar_changes.progressPercent = /*progressPercent*/ ctx[2];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			$$invalidate(2, progressPercent = (totalSeconds - secondsLeft) / totalSeconds * 100);
    		}
    	};

    	return [secondsLeft, isRunning, progressPercent, startTimer];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img src="handwashing.gif" alt="How to wash your hands." bp="offset-5@md 4@md 12@sm" class="svelte-wwxt9"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			if (!src_url_equal(audio_1.src, audio_1_src_value = "timer_done.m4a")) attr(audio_1, "src", audio_1_src_value);
    		},
    		m(target, anchor) {
